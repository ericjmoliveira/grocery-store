            ...
            {isLoadingProductsData ? (
                ...
                <section>
                    ...
                    <Styles.Category>
                        {productsList.map(
                            (item) =>
                                item.category === 'Snacks' && <Card key={item.id} info={item} />
                        )}
                    </Styles.Category>
                    ...
                    <Styles.Category>
                        {productsList.map(
                            (item) =>
                                item.category === 'Beverages' && <Card key={item.id} info={item} />
                        )}
                    </Styles.Category>
                    ...
                    <Styles.Category>
                        {productsList.map(
                            (item) =>
                                item.category === 'Pantry' && <Card key={item.id} info={item} />
                        )}
                    </Styles.Category>
